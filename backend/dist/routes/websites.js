...
router.route('/')
    ...
    .post(validation_1.websiteValidation, validation_1.validate, websiteController.createWebsite);
router.route('/:id')
    .get(websiteController.getWebsite)
    .patch(validation_1.updateWebsiteValidation, validation_1.validate, websiteController.updateWebsite)
