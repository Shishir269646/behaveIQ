...
const getExperiments = asyncHandler(async (req, res) => {
    ...
    await checkOwnership(websiteId, req.user.id); // Use req.user.id
...
const getExperiment = asyncHandler(async (req, res) => {
    ...
    // Verify ownership
    await checkOwnership(experiment.websiteId, req.user.id); // Use req.user.id
...
const updateExperiment = asyncHandler(async (req, res) => {
    ...
    await checkOwnership(existing.websiteId, req.user.id); // Use req.user.id
