 ...
 */
export const callMLService = async (endpoint: string, payload: any, method: Method = 'POST'): Promise<any> => {
 ...
 */
export const generateContent = async (personaDescription: string, contentType: string): Promise<any> => {
    try {
