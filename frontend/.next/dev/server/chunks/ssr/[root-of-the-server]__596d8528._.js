...
api.interceptors.response.use((response)=>{
    ...
    if (error.response) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('Server এর সাথে connection হচ্ছে না');
    } else {
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('কিছু ভুল হয়েছে');
    }
    return Promise.reject(error);
});
const authAPI = {
...
const sitesAPI = {
    ...
    getKeys: (id)=>api.get(`/sites/${id}/keys`),
    regenerateKey: (id)=>api.post(`/sites/${id}/keys/regenerate`)
};
const variantsAPI = {
    getAll: (siteId)=>api.get(`/variants/sites/${siteId}/variants`),
    getOne: (id)=>api.get(`/variants/${id}`),
    create: (siteId, data)=>api.post(`/variants/sites/${siteId}/variants`, data),
    update: (id, data)=>api.put(`/variants/${id}`, data),
    delete: (id)=>api.delete(`/variants/${id}`),
    updateStatus: (id, status)=>api.patch(`/variants/${id}/status`, {
            status
        })
};
const analyticsAPI = {
    getSiteAnalytics: (siteId, params)=>api.get(`/analytics/sites/${siteId}`, {
            params
        }),
    getVariantPerformance: (siteId)=>api.get(`/analytics/sites/${siteId}/variants`),
    getFunnel: (siteId, steps)=>api.get(`/analytics/sites/${siteId}/funnel`, {
            params: {
                steps: steps.join(',')
            }
        })
...
;
;
const useAuth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["create"])((set, get)=>({
        user: null,
        token: null,
        isLoading: false,
        ...
        login: async (email, password)=>{
            ...
            try {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success('সফলভাবে লগইন হয়েছে!');
                return true;
            } catch (error) {
                set({
                    isLoading: false
        ...
        register: async (name, email, password)=>{
            ...
            try {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success('সফলভাবে রেজিস্টার হয়েছে!');
                return true;
            } catch (error) {
                set({
                    isLoading: false
        ...
        logout: ()=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success('লগআউট হয়েছে');
        },
        checkAuth: async ()=>{
            ...
            try {
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authAPI"].getMe();
...
function Sidebar() {
    ...
    const { logout, user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAuth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "flex items-center h-16 px-6 border-b border-gray-800",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                    className: "text-xl font-bold text-white",
                    children: "PersonaFlow"
                }, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
                ...
                children: navigation.map((item)=>{
                    ...
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                        href: item.href,
                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])('flex items-center px-4 py-3 rounded-lg transition-colors', isActive ? 'bg-primary-600 text-white' : 'text-gray-300 hover:bg-gray-800 hover:text-white'),
                        children: [
...
function DashboardLayout({ children }) {
    ...
    const { isAuthenticated, isLoading, checkAuth } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAuth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useAuth"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__596d8528._.js.map