        ...
        <>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className='text-sm text-muted-foreground'>
                  Average predicted risk for current sessions.
                </p>
              </CardContent>
            </Card>
            <Card>
              ...
              <CardContent>
                <div className='text-4xl font-bold'>
                  {data.interventionsTriggered}
                </div>
                <p className='text-sm text-muted-foreground'>
                  Number of times AI intervened.
                </p>
              </CardContent>
            </Card>
            <Card>
              ...
              <CardContent>
                ...
                <p className='text-sm text-muted-foreground'>
                  Percentage of carts recovered after intervention.
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <Card>
            ...
            <CardContent>
              <Table>
                ...
                <TableBody>
                  {data.interventionPerformance.map(
                    (item: InterventionPerformance, index: number) => (
                      <TableRow key={index}>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Historical trend of average abandonment risk.
              </CardDescription>
            </CardHeader>
            <CardContent>
