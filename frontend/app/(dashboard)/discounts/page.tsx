          ...
          <div className='space-y-4'>
              ...
              <Popover>
                <PopoverTrigger asChild>
                  ...
                  >
                    ...
                    {formState.expiresAt ? (
                      format(formState.expiresAt, 'PPP')
                    ) : (
                ...
                <PopoverContent className='w-auto p-0' align='start'>
                  <Calendar
                    ...
                    onSelect={(date) =>
                      date && setFormState({ ...formState, expiresAt: date })
                    }
                    initialFocus
                  />
                </PopoverContent>
            ...
            <div className='space-y-2'>
              ...
              <Select
                ...
                onValueChange={(value: 'active' | 'used' | 'expired') =>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
              {[
                ...
                <div
                  key={reasonOption.factor}
                  className='flex items-center space-x-2'
                >
                  <Checkbox
                    id={`reason-${reasonOption.factor}`}
                    checked={formState.reasons.some(
                      (r) => r.factor === reasonOption.factor
                    )}
                    onCheckedChange={(checked) => {
                      if (checked) {
                        setFormState((prev) => ({
                          ...
                          reasons: [
                            ...prev.reasons,
                            { factor: reasonOption.factor, value: 0 },
                          ], // Value will be calculated by backend
                        }))
                      } else {
                        setFormState((prev) => ({
                          ...prev,
                  ...
                  />
                  <Label htmlFor={`reason-${reasonOption.factor}`}>
                    {reasonOption.label}
                  </Label>
                </div>
              ))}
