  ...
  return (
    <div className='flex flex-col gap-4'>
      ...
      <p className='text-muted-foreground'>
        System runs experiments automatically and declares winners based on
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Manage and track your A/B tests.</CardDescription>
        </CardHeader>
                  ...
                  >
                    <TableRow className='cursor-pointer'>
                      ...
                      {(() => {
                        ...
                        const formattedConversionLift =
                          conversionLiftValue !== undefined &&
                          conversionLiftValue !== null
                          ...
                          <TableCell
                            className={
                              ...
                              conversionLiftValue !== null
                                ...
                                : 'text-muted-foreground' // Default class if undefined or null
                            }
                          >
                            {' '}
                      ...
                      <TableCell>
                        {(() => {
                          ...
                          if (exp.status === 'completed') {
                            ...
                            const totalVisitors = exp.variations.reduce(
                              (sum, variation) => sum + variation.visitors,
                              0
                            )
                            const minSampleSize =
                              exp.settings?.minSampleSize || 0
                            if (minSampleSize > 0) {
                              progressValue = Math.min(
                                (totalVisitors / minSampleSize) * 100,
                                100
                              )
                            }
                          }
