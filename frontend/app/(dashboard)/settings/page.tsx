...
export default function SettingsPage() {
      ...
      const fetchSessions = async () => {
        try {
          const response = await api.get(
            `/websites/${selectedWebsite._id}/sessions`
          )
  ...
  const handleEmotionInterventionChange = (
    index: number,
    field: string,
    value: any
  ) => {
    const updatedInterventions = [
      ...(websiteFormState.settings.emotionInterventions || []),
    ]
  ...
  const handleRemoveEmotionIntervention = (index: number) => {
    setWebsiteFormState((prev: any) => ({
      ...
      settings: {
        ...prev.settings,
        emotionInterventions: prev.settings.emotionInterventions.filter(
  ...
  const handleSaveSecurity = async () => {
    ...
    await updateAuthenticatedUser({
      settings: {
        twoFactorEnabled: profileFormState.settings?.twoFactorEnabled,
      },
    })
  }
    ...
    await updateAuthenticatedUser({
      settings: {
        emailNotificationsEnabled:
          profileFormState.settings?.emailNotificationsEnabled,
        pushNotificationsEnabled:
          profileFormState.settings?.pushNotificationsEnabled,
      },
    })
  }
        ...
        <TabsContent value='website'>
            ...
            <CardContent className='space-y-4'>
              ...
              <div className='flex items-center space-x-2'>
                <Checkbox
                  ...
                  checked={websiteFormState.settings.autoPersonalization}
                  onCheckedChange={(checked: boolean) =>
                    handleWebsiteSettingsChange('autoPersonalization', checked)
                  }
                />
                <Label htmlFor='auto-personalization'>
              ...
              <div className='flex items-center space-x-2'>
                <Checkbox
                  id='experiment-mode'
                  checked={websiteFormState.settings.experimentMode}
                  onCheckedChange={(checked: boolean) =>
                    handleWebsiteSettingsChange('experimentMode', checked)
                  }
                />
          ...
          <Card className='mt-4'>
            <CardHeader>
              ...
              <CardDescription>
                Manually trigger the persona discovery process. This will
                analyze the latest user data to identify new personas.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Button
          ...
          <Card className='mt-4'>
            ...
            <CardContent className='space-y-4'>
              {websiteFormState.settings.emotionInterventions &&
                websiteFormState.settings.emotionInterventions.map(
                      ...
                      <div className='space-y-2'>
                        ...
                        <Select
                          ...
                          onValueChange={(value: any) =>
                            handleEmotionInterventionChange(
                              index,
                              'emotion',
                              value
                            )
              ...
              <Button
                variant='outline'
                className='w-full'
                onClick={handleAddEmotionIntervention}
              >
        ...
        <TabsContent value='security'>
            ...
            <CardContent className='space-y-6'>
              <div className='flex flex-row items-center justify-between rounded-lg border p-4'>
                ...
                <Checkbox
                  ...
                  onCheckedChange={(checked: boolean) =>
                    handleProfileSettingsChange('twoFactorEnabled', checked)
                  }
                  disabled={authLoading}
                />
              </div>
              <Button onClick={handleSaveSecurity} disabled={authLoading}>
          ...
          <Card className='mt-4'>
            <CardHeader>
              ...
              <CardDescription>
                Configure the sensitivity and automated actions for fraud
                detection.
              </CardDescription>
            </CardHeader>
            <CardContent className='space-y-4'>
              ...
              <p className='text-sm text-muted-foreground mb-2'>
                Automated actions taken when high fraud risk is detected.
              </p>
              <div className='space-y-2'>
                <div className='flex items-center space-x-2'>
                  <Checkbox
                    ...
                    checked={
                      websiteFormState.settings.fraudDetectionSettings
                        ?.riskBasedActions?.requirePhoneVerification || false
                    }
                    onCheckedChange={(checked: boolean) =>
                      handleWebsiteSettingsChange('fraudDetectionSettings', {
                        ...websiteFormState.settings.fraudDetectionSettings,
                ...
                <div className='flex items-center space-x-2'>
                  <Checkbox
                    ...
                    checked={
                      websiteFormState.settings.fraudDetectionSettings
                        ?.riskBasedActions?.requireEmailVerification || false
                    }
                    onCheckedChange={(checked: boolean) =>
                      handleWebsiteSettingsChange('fraudDetectionSettings', {
                        ...websiteFormState.settings.fraudDetectionSettings,
                ...
                <div className='flex items-center space-x-2'>
                  <Checkbox
                    ...
                    checked={
                      websiteFormState.settings.fraudDetectionSettings
                        ?.riskBasedActions?.disableCOD || false
                    }
                    onCheckedChange={(checked: boolean) =>
                      handleWebsiteSettingsChange('fraudDetectionSettings', {
                        ...websiteFormState.settings.fraudDetectionSettings,
                ...
                <div className='flex items-center space-x-2'>
                  <Checkbox
                    ...
                    checked={
                      websiteFormState.settings.fraudDetectionSettings
                        ?.riskBasedActions?.showCaptcha || false
                    }
                    onCheckedChange={(checked: boolean) =>
                      handleWebsiteSettingsChange('fraudDetectionSettings', {
                        ...websiteFormState.settings.fraudDetectionSettings,
                ...
                <div className='flex items-center space-x-2'>
                  <Checkbox
                    ...
                    checked={
                      websiteFormState.settings.fraudDetectionSettings
                        ?.riskBasedActions?.manualReview || false
                    }
                    onCheckedChange={(checked: boolean) =>
                      handleWebsiteSettingsChange('fraudDetectionSettings', {
                        ...websiteFormState.settings.fraudDetectionSettings,
                ...
                <div className='space-y-2'>
                  <Label htmlFor='limitOrderValue'>
                    Limit Order Value (USD)
                  </Label>
                  <Input
                    id='limitOrderValue'
                    type='number'
                    value={
                      websiteFormState.settings.fraudDetectionSettings
                        ?.riskBasedActions?.limitOrderValue || ''
                    }
                    onChange={(e) =>
                      handleWebsiteSettingsChange('fraudDetectionSettings', {
                        ...websiteFormState.settings.fraudDetectionSettings,
            ...
            <CardContent className='space-y-6'>
              ...
              <div className='flex flex-row items-center justify-between rounded-lg border p-4'>
                ...
                <Checkbox
                  ...
                  checked={
                    profileFormState.settings?.pushNotificationsEnabled || false
                  }
                  onCheckedChange={(checked: boolean) =>
                    handleProfileSettingsChange(
                      'pushNotificationsEnabled',
              ...
              <Button onClick={handleSaveNotifications} disabled={authLoading}>
