          ...
          <div className='space-y-4 pb-4'>
            ...
            <div>
              ...
              <div className='flex flex-wrap gap-2 mt-2'>
                ...
                <Badge variant='outline'>
                  Intent:{' '}
                  {session.intentScore ? session.intentScore.final : 'N/A'}
                </Badge>
                <Badge
                  variant={
            ...
            <div>
              ...
              {isLoadingDevices ? (
                            ...
                            <ul className='list-disc pl-5'>
                              {device.stitchedWith.map((stitch, sIdx) => (
                                <li key={sIdx} className='break-all'>
                                  {stitch.fingerprint.substring(0, 10)}...
                                  (Confidence: {stitch.confidence.toFixed(2)})
                                </li>
                              ))}
                            </ul>
                          </div>
                ...
                <p className='text-sm text-muted-foreground'>
                  No other devices found for this user.
                </p>
              )}
            </div>
